...
enum ClientMessageKind {
    ...
    /// A pre-serialized frame sent verbatim.
    Raw(String),
}
...
impl ClientMessage {
    ...
    pub fn neg_msg(sub_id: String, message: String) -> Self {
    ...
    pub fn to_json(&self) -> Result<String, Error> {
        Ok(match &self.0 {
            ...
            ClientMessageKind::Raw(raw) => raw.clone(),
        })
    }
}
